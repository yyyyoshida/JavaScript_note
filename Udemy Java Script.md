...
## [記法補足](https://zenn.dev/ojk/books/intro-to-javascript/viewer/js-object)
...
## while文を使って入力した数字の中から一つの数字を当てる
```php
let maximum = parseInt(prompt('数字を入力しください:'));
while (!maximum) {
  maximum = parseInt(
...
let guess = prompt('一つ数字を決めました。数字を当ててください:');
let count = 1;
...
## [複数の引数](https://tcd-theme.com/2022/04/javascript-function-parameter-argument.html)
## [return・戻り値](https://tcd-theme.com/2022/04/javascript-function-return.html)
...
## [レキシカルスコープ１](https://allegretto-works.com/js/995/#index_id10)　
## [レキシカルスコープ２](https://yuito-blog.com/scope/#index_id3)　
## [関数リテラル【関数式、無名関数】](https://qiita.com/gone0021/items/0ebd261ec22c2de6289e)
## [無名関数　使用時](https://www.javadrive.jp/javascript/function/index5.html#section3)
## [関数式と無名関数の違い１](https://it-biz.online/web-design/function-expression/)
...
## [関数をreturnする１](https://itsakura.com/javascript_koukai)
## 関数をreturnする２
```php
...
## [パラメータの分割代入](https://zenn.dev/rabee/articles/javascript-destructuring-assignment-default-params)
## []()
## []()
## []()
## []()
